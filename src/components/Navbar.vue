<template>
  <div class="navbar bg-base-100">
    ...
    <div class="flex-none font-bold gap-2">
      <button @click="goHome" class="btn min-h-10 w-24 h-10 rounded-[100px] bg-white border-none shadow-none hover:bg-[#825514] hover:text-white" :class="{'!bg-[#825514] !text-white': $route.path === '/'}">設計案例</button>
      <button @click="goAbout" class="btn min-h-10 w-20 h-10 rounded-[100px] bg-white border-none shadow-none hover:bg-[#825514] hover:text-white" :class="{'!bg-[#825514] !text-white': $route.path === '/About'}">關於我</button>
      <button class="btn min-h-10 w-[116px] h-10 rounded-[100px] bg-[#FFDDB9] border-none hover:bg-[#FFDDB9]">下載履歷
