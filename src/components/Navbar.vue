<template>
  <div class="navbar bg-base-100 sticky top-0 z-50">
    ...
    <div class="flex-none font-bold gap-2">
      <button @click="goHome" class="btn min-h-10 w-24 h-10 rounded-[100px] bg-white text-[#825514]  border-none shadow-none hover:bg-[#825514] hover:bg-opacity-[12%]" :class="{'!bg-[#825514] !text-white': $route.path === '/'}">設計案例</button>
      <button @click="goAbout" class="btn min-h-10 w-20 h-10 rounded-[100px] bg-white text-[#825514] border-none shadow-none hover:bg-[#825514] hover:bg-opacity-[12%]" :class="{'!bg-[#825514] !text-white': $route.path === '/About'}">關於我</button>
      <button class="btn min-h-10 w-[116px] h-10 rounded-[100px] bg-[#FFDDB9] border-none flex items-center hover:bg-[#E3C5A7]">
