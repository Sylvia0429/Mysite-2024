<template>
  <div class="py-14">
    <p class="text-[28px] font-bold">如果你有任何想法想交流，歡迎與我聯絡 📧</p>
    <div class="py-6">
    ...
    <div>
      ...
      <div class="flex justify-between">
        <a href="mailto:a0918109701@gmail.com" class="text-xl text-[#4F4F4F] underline">a0918109701@gmail.com</a>
        <p class="text-[#4F4F4F]">@ Sylvia Chen 2024 Copyright. All Rights Reserved.</p>
      </div>
      </div>
  </div>
</template>
